...
export const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="topbar topbar--center page-width page-width--full z-20 relative grid py-0 h-full w-full items-center">
          <div className="social-icons hidden lg:flex items-center">
            <ul className="flex flex-wrap items-center gap-6">
              <li>
                <a
                  href="https://www.facebook.com/thebarsys/"
                  className="social_platform block relative"
                  is="magnet-link"
                  title="Barsys on Facebook"
                >
                  <svg
                    className="icon icon-facebook icon-sm"
                    viewBox="0 0 24 24"
                    stroke="none"
                    fill="currentColor"
              ...
              <li>
                ...
                >
                  <svg
                    className="icon icon-twitter icon-sm"
                    viewBox="0 0 24 24"
                    stroke="none"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                ...
                >
                  <svg
                    className="icon icon-instagram icon-sm"
                    viewBox="0 0 24 24"
                    stroke="none"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                ...
                >
                  <svg
                    className="icon icon-youtube icon-sm"
                    viewBox="0 0 24 24"
                    stroke="none"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                ...
                >
                  <svg
                    className="icon icon-pinterest icon-sm"
                    viewBox="0 0 24 24"
                    stroke="none"
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="announcement-bar h-full flex justify-center lg:justify-center relative">
            <announcement-bar
              id="Slider-sections--15951466070097__announcement-bar"
              className="announcement__slides flex justify-center w-full h-full flickity"
              autoplay
              autoplay-speed="5"
            >
              <div className="announcement__slide flex h-full">
                <div className="announcement__content flex items-center gap-2">
                  <p className="announcement-text leading-tight">
                    Coaster 2.0 Now Shipping!
                  </p>
                </div>
              </div>
              <div
                className="announcement__slide flex h-full"
                aria-hidden="true"
              >
                <div className="announcement__content flex items-center gap-2">
                  <p className="announcement-text leading-tight">
            ...
            <button
              ...
              aria-controls="Slider-sections--15951466070097__announcement-bar"
              aria-label="Previous"
            >
              <svg
                className="icon icon-arrow-left icon-xs transform"
                viewBox="0 0 15 14"
                fill="none"
                stroke="currentColor"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button
              type="button"
              is="next-button"
              className="fader right relative flex items-center justify-end h-full"
              aria-controls="Slider-sections--15951466070097__announcement-bar"
              aria-label="Next"
            >
              <svg
                className="icon icon-arrow-right icon-xs transform"
                viewBox="0 0 15 14"
                fill="none"
                stroke="currentColor"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button
              type="button"
              className="slideshow-control flex items-center justify-center rounded-full sr-only"
              is="control-button"
              aria-controls="Slider-sections--15951466070097__announcement-bar"
              aria-live="polite"
            >
              <span className="slideshow-control__pause">
                <svg
                  className="icon icon-pause icon-md"
                  viewBox="0 0 36 36"
                  stroke="currentColor"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="slideshow-control__play">
                <svg
                  className="icon icon-play icon-md"
                  viewBox="0 0 36 36"
                  stroke="none"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="drawer__inner z-10 absolute top-0 flex flex-col w-full h-full overflow-hidden">
            ...
            <div class="drawer__content opacity-0 invisible flex flex-col h-full grow shrink">
              <nav class="relative grow overflow-hidden" role="navigation">
                <ul
                  class="drawer__scrollable drawer__menu relative w-full h-full"
                  role="list"
                  data-parent
                >
                  <li>
                    <details is="menu-details">
                      ...
                      >
                        <button
                          type="button"
                          class="tracking-tight text-base font-bold shrink-0 flex items-center gap-3 w-full"
                        >
                          Shop
                        </button>
                        <ul class="drawer__scrollable flex flex-col h-full">
                          <li>
                            <details is="menu-details">
                              ...
                              <div class="drawer__submenu z-1 absolute top-0 left-0 w-full h-full">
                                <button
                                  type="button"
                                  class="tracking-tight text-base font-bold flex items-center gap-3 w-full"
                                >
                                  Cocktail Maker
                                </button>
                                <ul class="grid">
                                  <li>
                                    <a
                                      class="drawer__menu-item block text-2xl font-bold leading-none tracking-tight"
                          ...
                          <li class="drawer__promotions">
                            <ul
                              class="mega-menu__list grid grid-cols-2 w-full h-full"
                              role="list"
                              tabindex="-1"
                            >
                                ...
                                >
                                  ...
                                  <div class="media-card__content flex justify-between items-center gap-4 w-full">
                                    <div class="media-card__text opacity-0 shrink-1">
                                      <span class="heading reversed-link text-lg font-bold tracking-tighter leading-none">
                                        Barsys 360
                                      </span>
                              ...
                              <li class="mega-menu__item media-card media-card--card media-card--overlap overflow-hidden opacity-0 w-full">
                                ...
                                >
                                  <div class="media media--adapt relative overflow-hidden">
                                    <Image
                                      src={require("../../../assets/images/Coaster_Lifestyle.jpg")}
                                      alt=""
                                      loading="lazy"
                                      is="lazy-image"
                                    />
                                  ...
                                  <div class="media-card__content flex justify-between items-center gap-4 w-full">
                                    <div class="media-card__text opacity-0 shrink-1">
                                      ...
                                      <p class="leading-none text-xs xl:text-sm hidden md:block">
                                        Mixology Made Effortless: Barsys Coaster
                                        2.0
                                      </p>
                                    </div>
                                    <svg
                        ...
                        <ul class="drawer__scrollable flex flex-col h-full">
                          <li class="drawer__promotions">
                            <ul
                              ...
                              tabindex="-1"
                            >
                              <li class="mega-menu__item media-card media-card--card overflow-hidden opacity-0 w-full">
                                <a
                                  class="media-card__link grid w-full h-full relative"
                                  href="bars.html"
                                ...
                                >
                                  <div class="media media--adapt relative overflow-hidden">
                                    <Image
                                      src={require("../../../assets/images/bars.jpg")}
                                      alt=""
                                      loading="lazy"
                                      is="lazy-image"
                                    />
                              ...
                              <li class="mega-menu__item media-card media-card--card overflow-hidden opacity-0 w-full">
                                ...
                                >
                                  <div class="media media--adapt relative overflow-hidden">
                                    <Image
                                      src={require("../../../assets/images/Mixologist.jpg")}
                                      alt=""
                                      loading="lazy"
                                      is="lazy-image"
                                    />
                              ...
                              <li class="mega-menu__item media-card media-card--card media-card--overlap overflow-hidden opacity-0 w-full">
                                ...
                                >
                                  <div class="media media--adapt relative overflow-hidden">
                                    <Image
                                      src={require("../../../assets/images/all-recipes.jpg")}
                                      alt=""
                                      loading="lazy"
                                      is="lazy-image"
                                    />
              ...
              <div class="drawer__footer grid w-full">
                <div class="drawer__footer-top flex">
                  ...
                  <modal-element
                    id="LocalizationCountry-sections--15951466070097__header"
                  ...
                  >
                    ...
                    <div class="modal__container flex flex-col z-3 absolute left-0 bottom-0 w-full">
                      ...
                      >
                        ...
                        <ul
                          class="modal__scrollable listbox grid gap-1d5 xl:gap-2"
                          role="list"
                          tabindex="-1"
                        >
                          <li class="opacity-0">
                            ...
                            >
                              <div class="media media--adapt relative overflow-hidden">
                                <Image
                                  ...
                                  is="lazy-image"
                                />
                                {/* <Image src="assets/images/Explore_all_recipes.jpg" alt="" is="lazy-image" /> */}
                              </div>
                              <div class="media-card__content flex justify-between items-center gap-4 w-full">
                                <div class="media-card__text opacity-0 shrink-1">
                                  <span class="heading reversed-link text-xl-3xl font-bold tracking-tighter leading-none relative">
