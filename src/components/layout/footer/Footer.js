...
export const Footer = () => {
  return (
    ...
    <footer-group class="footer-group block w-full"> 
            <div id="shopify-section-sections--15951473213521__multicolumn-with-icons"
                ...
                <div class="section section--padding section--divider">
                    <div class="page-width relative"><carousel-element
                            class="text-with-icons block lg:grid grid--4 relative z-1" watch-css>
                            <div class="column flex gap-5 w-full flex-col xl:flex-row xl:text-left text-center">
                                <div class="column__icon"><svg class="icon icon-support icon-lg inline-block"
                                ...
                                <div class="column__content">
                                    ...
                                    <div class="column__text rte">
                                        <p>Discover exceptional service with our dedicated customer support team.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="column flex gap-5 w-full flex-col xl:flex-row xl:text-left text-center">
                                <div class="column__icon"><svg class="icon icon-box icon-lg inline-block"
                                        viewBox="0 0 24 24" stroke="currentColor" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill"
                                ...
                                <div class="column__content">
                                    ...
                                    <div class="column__text rte">
                                        <p>Experience swift and reliable delivery for your convenience.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="column flex gap-5 w-full flex-col xl:flex-row xl:text-left text-center">
                                <div class="column__icon"><svg class="icon icon-calendar icon-lg inline-block"
                                        viewBox="0 0 24 24" stroke="currentColor" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="column flex gap-5 w-full flex-col xl:flex-row xl:text-left text-center">
                                <div class="column__icon"><svg class="icon icon-shield icon-lg inline-block"
                                        viewBox="0 0 24 24" stroke="currentColor" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill"
            ...
            <div id="shopify-section-sections--15951473213521__footer"
                class="shopify-section shopify-section-group-footer-group">
                {/* <style data-shopify>
                    ...
                    <footer class="footer page-width relative grid">
                        <div class="footer__left flex flex-col md:flex-row gap-10">
                            ...
                            <div class="footer__accordions flex flex-wrap flex-col md:flex-row md:grow md:gap-12">
                                <details class="footer__item--link_list-1 details active" is="footer-details">
                                    <summary
                                        class="details__summary flex items-center justify-between gap-2 cursor-pointer">
                                        <span class="text-base-2xl font-medium">Quick Links</span><svg
                                            class="icon icon-chevron-up icon-md" viewBox="0 0 24 24"
                                        ...
                                        <ul class="flex flex-col gap-3">
                                            <li class="inline-flex">
                                                <a href="collections.html"
                                                    class="block reversed-link text-sm-lg leading-tight">Products</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="collection-recipes.html"
                                                    class="block reversed-link text-sm-lg leading-tight">All
                                                    Recipes</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="mixlist.html"
                                                    class="block reversed-link text-sm-lg leading-tight">Mixlists</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="bars.html"
                                                    class="block reversed-link text-sm-lg leading-tight">Bars</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="blog-list.html"
                                                    class="block reversed-link text-sm-lg leading-tight">Blogs</a>
                                            </li>
                                        </ul>
                                    </div>
                                    {/* <style>
                                ...
                                <details class="footer__item--link_list-2 details active" is="footer-details">
                                    <summary
                                        class="details__summary flex items-center justify-between gap-2 cursor-pointer">
                                        <span class="text-base-2xl font-medium">Information</span><svg
                                            class="icon icon-chevron-up icon-md" viewBox="0 0 24 24"
                                            stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 15L12 9L18 15">
                                            </path>
                                        ...
                                        <ul class="flex flex-col gap-3">
                                            <li class="inline-flex">
                                                <a href="our-story.html"
                                                    class="block reversed-link text-sm-lg leading-tight">Our Story</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="contact.html"
                                                    class="block reversed-link text-sm-lg leading-tight">Contact us</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="#"
                                                    class="block reversed-link text-sm-lg leading-tight">Shipping
                                                    Policy</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="#"
                                                    class="block reversed-link text-sm-lg leading-tight">Refund
                                                    Policy</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="#"
                                                    class="block reversed-link text-sm-lg leading-tight">Privacy
                                                    Policy</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="#"
                                                    class="block reversed-link text-sm-lg leading-tight">Terms
                                                    of Service</a>
                                            </li>
                                            <li class="inline-flex">
                                                <a href="#"
                                                    class="block reversed-link text-sm-lg leading-tight">Pre-Order Terms
                                                    and Conditions</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="footer__item--brand_information no-details">
                                    <div class="details__content">
                                        <div class="footer__contact flex flex-col gap-1">
                                            <p>
                                                <a class="link inline-block leading-tight text-left"
                                                    href="tel:+918448399200" is="magnet-link">
                                                    <span class="btn-text" data-text>+91 84483 99200</span>
                                                </a>
                                            </p>
                                            <p>
                                                <a class="link inline-block leading-tight text-left"
                                                    href="mailto:support@thebarsys.com" is="magnet-link">
                                                    <span class="btn-text" data-text>support@thebarsys.com</span>
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="footer__right grid gap-10">
                            <div class="footer__newsletter grid gap-6">
                                <p class="h3 text-xl leading-none tracking-none font-medium lg:font-bold">Subscribe to
                                    our newsletter
                                </p>
                                <form method="post" action="/contact#newsletter-sections--15951473213521__footer"
                                    id="newsletter-sections--15951473213521__footer" accept-charset="UTF-8"
                                    class="newsletter-form grid gap-5"><input type="hidden" name="form_type"
                                        value="customer" /><input type="hidden" name="utf8" value="✓" /><input
                                        type="hidden" name="contact[tags]" value="newsletter" />
                                    <input type="hidden" name="contact[context]" value="footer" />
                                    <div class="field relative">
                                        <input id="NewsletterForm--sections--15951473213521__footer"
                                            class="input is-floating input--fill" type="email" name="contact[email]"
                                            value="" autocorrect="off" autocapitalize="off" autocomplete="email"
                                            placeholder="Enter your email" required />
                                        <label class="label is-floating"
                                            for="NewsletterForm--sections--15951473213521__footer">Keep me
                                            notified</label>
                                        <div class="self-submit-button absolute">
                                            <button type="submit"
                                                class="button button--primary self-button flex justify-center items-center"
                                                is="magnet-button" data-magnet="20" aria-label="Subscribe">
                                                <span class="btn-text">
                                                    <svg class="icon icon-arrow-right icon-xs transform"
                            ...
                            <div class="footer__socials flex justify-start md:justify-end xl:justify-start">
                                <ul class="flex flex-wrap items-center gap-7">
                                    <li><a href="https://www.facebook.com/thebarsys/"
                                            ...
                                            title="Barsys on Facebook"><svg class="icon icon-facebook icon-lg"
                                    ...
                                    <li><a href="https://twitter.com/barsyscocktail"
                                            class="social_platform block relative" is="magnet-link"
                                            title="Barsys on Twitter"><svg class="icon icon-twitter icon-lg"
                                                viewBox="0 0 24 24" stroke="none" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li><a href="https://www.instagram.com/barsys.inc/"
                                            class="social_platform block relative" is="magnet-link"
                                            title="Barsys on Instagram"><svg class="icon icon-instagram icon-lg"
                                                viewBox="0 0 24 24" stroke="none" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li><a href="https://www.youtube.com/@TheBarsys"
                                            class="social_platform block relative" is="magnet-link"
                                            title="Barsys on YouTube"><svg class="icon icon-youtube icon-lg"
                                                viewBox="0 0 24 24" stroke="none" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li><a href="https://www.pinterest.com/barsyscoaster/"
                                            class="social_platform block relative" is="magnet-link"
                                            title="Barsys on Pinterest"><svg class="icon icon-pinterest icon-lg"
                                                viewBox="0 0 24 24" stroke="none" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        data-target="height" data-start="100%" data-stop="0%"></parallax-overlay>
                </div>


            </div>
            <div id="shopify-section-sections--15951473213521__footer-copyright"
                class="shopify-section shopify-section-group-footer-group">
                {/* <style data-shopify>
                ...
                <div class="section section--rounded" is="footer-parallax">
                    <div
                        class="footer-copyright page-width page-width--full w-full flex flex-col items-center justify-between gap-4 lg:gap-0 lg:flex-row relative">
                        <div class="rte credits text-center">&copy;&nbsp;2024&nbsp;Barsys.&nbsp;<a target="_blank"
                                rel="nofollow"
                                href="#">Powered
                                by Shopify</a>
                            <ul class="flex gap-3 justify-center lg:justify-start">
                                <li>
                                    <small>
                                        <a href="#" class="block reversed-link">Refund policy</a>
                                    </small>
                                </li>
                                <li>
                                    <small>
                                        <a href="#" class="block reversed-link">Privacy
                                            policy</a>
                                    </small>
                                </li>
                                <li>
                                    <small>
                                        <a href="#" class="block reversed-link">Terms of
                                            service</a>
                                    </small>
                                </li>
                                <li>
                                    <small>
                                        <a href="#" class="block reversed-link">Shipping
                                            policy</a>
                                    </small>
                                </li>
                            </ul>
                        ...
                        <div class="localization flex items-center justify-center flex-col md:flex-row">
                            <div class="grid gap-2">
                                <form method="post" action="/localization" id="localization_country_form_footer"
                                    accept-charset="UTF-8" class="localization__form flex items-center relative"
                                    enctype="multipart/form-data" is="localization-form"><input type="hidden"
                                        name="form_type" value="localization" /><input type="hidden" name="utf8"
                                        value="✓" /><input type="hidden" name="_method" value="put" /><input
                                        type="hidden" name="return_to" value="/" /><label class="sr-only"
                                        for="LocalizationCountryFormFooter">Country/region</label><svg
                                    ...
                                    </svg><select class="localization__item cursor-pointer leading-tight w-full"
                                        name="country_code" id="LocalizationCountryFormFooter">
                                        <option value="CA">Canada (INR ₹)
                                        </option>
                                        <option value="DE">Germany (INR ₹)
                                        </option>
                                        <option value="IN" selected>India (INR ₹)
                                        </option>
                                        <option value="IL">Israel (INR ₹)
                                        </option>
                                        <option value="NZ">New Zealand (INR ₹)
                                        </option>
                                        <option value="GB">United Kingdom (INR ₹)
                                        </option>
                                        <option value="US">United States (INR ₹)
                                        </option>
                                    </select><svg class="icon icon-chevron-down icon-xs absolute pointer-events-none"
                                        viewBox="0 0 24 24" stroke="currentColor" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 9L12 15L18 9"></path>
                                    </svg></form><noscript>
                                    <button class="button button--primary button--small w-full" type="submit"
                                        form="localization_country_form_footer">Update country/region</button>
                                </noscript>
                            </div>
                        </div>
                    </div>
